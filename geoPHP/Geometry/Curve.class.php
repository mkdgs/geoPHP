...
abstract class Curve extends Geometry {
	...
	/**
	 * Point — The start Point of this Curve.
	*/
	...
	/**
	 * Point — The end Point of this Curve.
	*/
	...
	/**
	 * Integer — Returns 1 (TRUE) if this Curve is closed [StartPoint ( ) = EndPoint ( )]
	*/
	...
	/**
	 * Integer — Returns 1 (TRUE) if this Curve is closed [StartPoint ( ) = EndPoint ( )] and this Curve is
